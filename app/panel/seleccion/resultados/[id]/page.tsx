...
import { useCandidato, useResultadoCMTPorCandidato } from "@/lib/hooks/useSelection"
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <NavigationLink href="/panel/seleccion/resultados">
      ...
      {cmtCompletada && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Perfil motivacional del candidato basado en el Cuestionario de Motivación para el Trabajo
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loadingCMT ? (
              ...
              <div className="space-y-6">
                {/* Componente de gráfico de resultados */}
                <CmtResultadoChart 
                ...
                <div className="grid md:grid-cols-2 gap-4 mt-6 pt-6 border-t">
                  ...
                  <div className="p-4 rounded-lg bg-blue-50 border border-blue-200">
                    <h4 className="font-semibold text-blue-900 mb-2">Información del Resultado</h4>
                    <p className="text-sm text-blue-700">
                      Género: {candidato.formulario?.genero || "No especificado"}
                    </p>
                    <p className="text-sm text-blue-700">
              ...
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground mb-2">
                  Los resultados de la prueba CMT aún no están disponibles.
                </p>
                <p className="text-sm text-muted-foreground">
                  Esto puede deberse a que la prueba fue completada recientemente y aún está siendo procesada.
                </p>
              </div>
            )}
          </CardContent>
