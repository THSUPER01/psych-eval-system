    ...
    <div className="relative space-y-6">
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <Link href="/panel/seleccion/configuracion">
        ...
        <Card className="border-2 border-[#7AC943]/20 hover:border-[#7AC943]/40 transition-all overflow-hidden">
          ...
          <CardContent>
            {loadingCandidatos ? (
              ...
              <>
                <div className="text-3xl font-bold text-[#7AC943]">{stats.completados}</div>
                <p className="text-xs text-gray-600 mt-1">
                  de <span className="font-semibold">{stats.totalCandidatos}</span> candidatos
                </p>
              </>
            )}
          </CardContent>
        ...
        {stats.totalCandidatos > 0 ? (
          <Card className="border-2 border-gray-100">
            <CardHeader className="pb-3">
              ...
              <CardDescription>Formularios completados vs pendientes</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-2 border-gray-100 bg-gray-50">
            <CardHeader className="pb-3">
              ...
              <CardDescription>Crea candidatos para visualizar estadísticas</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col items-center justify-center h-[250px] text-center">
                <AlertCircle className="h-12 w-12 text-gray-300 mb-3" />
                <p className="text-sm text-gray-500">No hay candidatos registrados aún</p>
              </div>
            </CardContent>
          </Card>
        )}
      ...
      <div className="grid gap-4 md:grid-cols-2 relative z-10">
        <Card className="border-2 border-gray-100">
          ...
          <CardContent className="space-y-2">
            <Link href="/panel/seleccion/requerimientos">
            ...
            <Link href="/panel/seleccion/candidatos">
              ...
              <Link href="/panel/seleccion/candidatos/publicos">
              ...
              <div className="space-y-2 max-h-96 overflow-y-auto">
                {requerimientos
                  ...
                  .map((req) => (
                    <Link
                      key={req.reqId}
                      href={`/panel/seleccion/requerimientos/${req.reqId}`}
